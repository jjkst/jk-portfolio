...
export const PRODUCTS: Project[] = [
  ...
  },
  {
    ...
    Type: 'Test Automation',
    Roles: 'SDET',
    TechStack: 'Playwright, C#, Reqnroll, BDD',
    Description:
    ...
    Features: [
      {
        ...
        <b>Directory Structure</b>:<br>
          Pages/: Contains the Page Object classes for each page of the application.<br>
          Tests/: Contains the test cases.<br>
          Data/: Stores test data (e.g., CSV, JSON files).<br>
          Utilities/: Helper methods and reusable components.`,
      },
      {
